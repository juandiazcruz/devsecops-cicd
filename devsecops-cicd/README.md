...
2. Create the sonarqube server with docker-compose.yml or workshop/templates/ec2-sonarqube-zap.yaml
3. Create the codecommit repository and deploy the code inside workshop/templates/workshop-java-repo-vulnerable on it. 
4. Deploy ElasticBeanstalk environment with workshop/templates/elasticbeanstalk-infrastructure-java.yaml
5. Configure SecurityHub. 
6.	On the CloudFormation console, choose Create Stack. 
7.	Choose the provided CloudFormation pipeline template. 
8.	Choose Next.
9.	Provide the stack parameters:
